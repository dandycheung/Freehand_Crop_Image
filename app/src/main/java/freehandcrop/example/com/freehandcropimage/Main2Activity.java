...
public class Main2Activity extends AppCompatActivity {
    ...
    private static final String IMAGE_DIRECTORY = "/virtualtrailroom";
    ImageView ivChoose;
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    CommonUtils.WriteSharePrefrence(Main2Activity.this, Constant.IMAGE, encodedImage);
...
//                    i.putExtra("Image", bitmap);
            ...
            ivChoose.setImageBitmap(bitmap2);

            ByteArrayOutputStream b2 = new ByteArrayOutputStream();
            bitmap2.compress(Bitmap.CompressFormat.JPEG, 100, b2);
            byte[] b = b2.toByteArray();
